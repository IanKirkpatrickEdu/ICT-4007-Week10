...
def custom_format(record: dict) -> str:
    """Add more to the default loguru format."""
    # If you do not do this setup, this is the default loguru logging format
    ...
    # only add extra context if you have something to add
    if extra:
